...
HD_PWD='/home/sims0702/Downloads/DDC_project4-main/lab3.runs/design_1_VGA_timings_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_VGA_timings_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_VGA_timings_0_0.tcl
